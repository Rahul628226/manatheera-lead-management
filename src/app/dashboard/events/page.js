    ...
    return (
        <main className="max-w-[1440px] mx-auto px-4 md:px-6 py-6 md:py-8 w-full">
            <div className="flex justify-between items-center gap-4 mb-8">
                <div>
                    <h1 className="text-slate-900 text-2xl md:text-3xl font-black italic tracking-tight uppercase">Event Management</h1>
                    <p className="text-slate-400 text-[10px] md:text-xs font-bold uppercase tracking-widest mt-1">Configure your event inventory</p>
                </div>
                <button
